...
function Contact() {
  ...
  return (
    <div id='contact' className="cont relative w-full h-screen flex flex-col md:flex-row p-10 mt-20 justify-center md:justify-between items-center">
        <div className="socials lg:w-[15%] w-full md:w-[20%] h-[50%] md:h-[60%] flex flex-col items-center md:items-start justify-evenly">
        ...
        <div className='w-[90%] relative h-[50%] md:h-[90%] z-10 flex flex-col items-center justify-evenly'>
            <div className='w-[90%] h-[20%] hidden md:flex justify-evenly '>
                <h1 className='w-[30%] md:w-[40%] animate-letters  lg:text-2xl font-extrabold '>Social Media Here!</h1>
                <h1 className='w-[30%] md:w-[40%] animate-letters3 lg:text-2xl font-extrabold '>My Email Here!</h1>
                <h1 className='w-[30%] md:w-[40%] animate-letters2 lg:text-2xl font-extrabold '>My CV Here!</h1>
            ...
            <div className=' w-[90%] h-[80%] md:h-[20%] flex md:flex-row flex-col justify-evenly md:justify-between px-9 lg:px-20 items-center'>
                <div className="animate-bounce hover:animate-none card group w-[80%] lg:w-[13%] md:w-[20%] md:h-[50%] lgh-[90%] hover:lg:w-[50%] transition-all duration-500 rounded-full border-2 border-main drop-shadow-3xl bg-white flex justify-center items-center">
                    <h1 className='group-hover:w-fit group-hover:inline-block text-facebook transition-all duration-500 text-xl font-bold w-0 hidden overflow-hidden'>Hassan.Osama720@gmail.com</h1>
